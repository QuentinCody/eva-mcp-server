...
console.log(`${BLUE}🧪 EVA Structured Content Regression Tests${RESET}`);
...
assertContains('src/index.ts', indexContent, 'EvaDataDO', 'index.ts exports EvaDataDO');
...
console.log(`\n${GREEN}✅ EVA structured content regression tests passed.${RESET}`);
